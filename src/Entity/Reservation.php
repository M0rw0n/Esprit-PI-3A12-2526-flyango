...
private string $emailClient = '';
    ...
    public function setPaymentMethod(?string $p): static { $this->paymentMethod = $p; return $this; }
    public function getPaidAt(): ?\DateTimeInterface { return $this->paidAt; }
    public function setPaidAt(?\DateTimeInterface $p): static { $this->paidAt = $p; return $this; }
