...
<<<<<<< HEAD
    ...
    public function addBlockedDate(string $date): static { 
        $this->blockedDates = $this->blockedDates ?? [];
    ...
    public function addGaleriePhoto(string $photo): static { 
        $this->galeriePhotos = $this->galeriePhotos ?? [];
    ...
    public function getVues(): int { return $this->vues ?? 0; }
    public function setVues(int $v): static { $this->vues = $v; return $this; }
    public function incrementVues(): static { $this->vues = ($this->vues ?? 0) + 1; return $this; }
    ...
    public function addPhoto360(string $photo): static { 
        $this->photos360 = $this->photos360 ?? [];
        $this->photos360[] = $photo;
        return $this; 
    }
    public function removePhoto360(string $photo): static {
        if ($this->photos360 && ($key = array_search($photo, $this->photos360)) !== false) {
