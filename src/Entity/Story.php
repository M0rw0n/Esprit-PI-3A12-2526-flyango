...
class Story
{
    ...
    #[ORM\OneToMany(mappedBy: 'story', targetEntity: StoryView::class, orphanRemoval: true)]
    private Collection $views;

    #[ORM\OneToMany(mappedBy: 'story', targetEntity: StoryReaction::class, orphanRemoval: true)]
