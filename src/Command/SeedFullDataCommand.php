...
class SeedFullDataCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->createUsers($io);
        $users = $this->em->getRepository(User::class)->findBy([], [], 1);
        $defaultUser = $users[0] ?? null;
        $this->createCircuits($io, 25, $defaultUser);
    ...
    private function createCircuits(SymfonyStyle $io, int $count, ?User $defaultUser): void
    {
