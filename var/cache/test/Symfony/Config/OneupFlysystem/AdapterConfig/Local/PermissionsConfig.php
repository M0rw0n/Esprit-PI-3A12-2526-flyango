...
namespace Symfony\Config\OneupFlysystem\AdapterConfig\Local;
...
class PermissionsConfig 
{
    ...
    public function file(array $value = []): \Symfony\Config\OneupFlysystem\AdapterConfig\Local\Permissions\FileConfig
    {
        if (null === $this->file) {
            $this->_usedProperties['file'] = true;
            $this->file = new \Symfony\Config\OneupFlysystem\AdapterConfig\Local\Permissions\FileConfig($value);
    ...
    public function dir(array $value = []): \Symfony\Config\OneupFlysystem\AdapterConfig\Local\Permissions\DirConfig
    {
        if (null === $this->dir) {
            $this->_usedProperties['dir'] = true;
            $this->dir = new \Symfony\Config\OneupFlysystem\AdapterConfig\Local\Permissions\DirConfig($value);
        } elseif (0 < \func_num_args()) {
    ...
    public function __construct(array $value = [])
    {
        if (array_key_exists('file', $value)) {
            $this->_usedProperties['file'] = true;
            $this->file = new \Symfony\Config\OneupFlysystem\AdapterConfig\Local\Permissions\FileConfig($value['file']);
            unset($value['file']);
        }

        if (array_key_exists('dir', $value)) {
            $this->_usedProperties['dir'] = true;
            $this->dir = new \Symfony\Config\OneupFlysystem\AdapterConfig\Local\Permissions\DirConfig($value['dir']);
            unset($value['dir']);
        }
