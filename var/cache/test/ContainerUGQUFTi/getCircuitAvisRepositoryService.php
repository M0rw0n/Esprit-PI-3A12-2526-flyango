 ...
 */
class getCircuitAvisRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\CircuitAvisRepository' shared autowired service.
     *
     * @return \App\Repository\CircuitAvisRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CircuitAvisRepository.php';

        return $container->privates['App\\Repository\\CircuitAvisRepository'] = new \App\Repository\CircuitAvisRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
