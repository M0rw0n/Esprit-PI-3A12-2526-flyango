 ...
 */
class getTransportOfferRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\TransportOfferRepository' shared autowired service.
     *
     * @return \App\Repository\TransportOfferRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TransportOfferRepository.php';

        return $container->privates['App\\Repository\\TransportOfferRepository'] = new \App\Repository\TransportOfferRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
