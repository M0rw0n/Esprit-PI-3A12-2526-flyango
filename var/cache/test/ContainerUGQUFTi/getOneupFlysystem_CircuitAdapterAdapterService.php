 ...
 */
class getOneupFlysystem_CircuitAdapterAdapterService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'oneup_flysystem.circuit_adapter_adapter' shared service.
     *
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['oneup_flysystem.circuit_adapter_adapter'] = $container->createProxy('LocalFilesystemAdapterGhost3634d74', static fn () => \LocalFilesystemAdapterGhost3634d74::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
        ...
        return ($lazyLoad->__construct((\dirname(__DIR__, 4).'/public/uploads/circuits'), NULL, 2, 2, NULL, false) && false ?: $lazyLoad);
    }
}
