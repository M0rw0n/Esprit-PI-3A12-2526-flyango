 ...
 */
class getFavoriteActivityRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\FavoriteActivityRepository' shared autowired service.
     *
     * @return \App\Repository\FavoriteActivityRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FavoriteActivityRepository.php';

        return $container->privates['App\\Repository\\FavoriteActivityRepository'] = new \App\Repository\FavoriteActivityRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
