 ...
 */
class getSonata_Admin_Block_AdminPreviewService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Sonata\AdminBundle\Block\AdminPreviewBlockService($a, ($container->privates['sonata.admin.pool'] ?? self::getSonata_Admin_PoolService($container)));

        if (isset($container->services['sonata.admin.block.admin_preview'])) {
            return $container->services['sonata.admin.block.admin_preview'];
        }

        return $container->services['sonata.admin.block.admin_preview'] = $instance;
    }
}
