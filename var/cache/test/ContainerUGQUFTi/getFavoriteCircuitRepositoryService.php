 ...
 */
class getFavoriteCircuitRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\FavoriteCircuitRepository' shared autowired service.
     *
     * @return \App\Repository\FavoriteCircuitRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FavoriteCircuitRepository.php';

        return $container->privates['App\\Repository\\FavoriteCircuitRepository'] = new \App\Repository\FavoriteCircuitRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
