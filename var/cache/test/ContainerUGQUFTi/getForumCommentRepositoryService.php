 ...
 */
class getForumCommentRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\ForumCommentRepository' shared autowired service.
     *
     * @return \App\Repository\ForumCommentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ForumCommentRepository.php';

        return $container->privates['App\\Repository\\ForumCommentRepository'] = new \App\Repository\ForumCommentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
