 ...
 */
class getCalendarEventRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\CalendarEventRepository' shared autowired service.
     *
     * @return \App\Repository\CalendarEventRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CalendarEventRepository.php';

        return $container->privates['App\\Repository\\CalendarEventRepository'] = new \App\Repository\CalendarEventRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
