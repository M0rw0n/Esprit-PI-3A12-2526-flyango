 ...
 */
class getTransportBookingRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\TransportBookingRepository' shared autowired service.
     *
     * @return \App\Repository\TransportBookingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TransportBookingRepository.php';

        return $container->privates['App\\Repository\\TransportBookingRepository'] = new \App\Repository\TransportBookingRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
