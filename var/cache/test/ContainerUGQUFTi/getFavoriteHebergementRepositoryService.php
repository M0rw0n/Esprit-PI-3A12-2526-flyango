 ...
 */
class getFavoriteHebergementRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\FavoriteHebergementRepository' shared autowired service.
     *
     * @return \App\Repository\FavoriteHebergementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FavoriteHebergementRepository.php';

        return $container->privates['App\\Repository\\FavoriteHebergementRepository'] = new \App\Repository\FavoriteHebergementRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
