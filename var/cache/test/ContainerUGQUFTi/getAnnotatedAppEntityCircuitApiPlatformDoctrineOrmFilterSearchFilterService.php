 ...
 */
class getAnnotatedAppEntityCircuitApiPlatformDoctrineOrmFilterSearchFilterService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'annotated_app_entity_circuit_api_platform_doctrine_orm_filter_search_filter' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['annotated_app_entity_circuit_api_platform_doctrine_orm_filter_search_filter'])) {
            return $container->privates['annotated_app_entity_circuit_api_platform_doctrine_orm_filter_search_filter'];
        }

        $instance = new \ApiPlatform\Doctrine\Orm\Filter\SearchFilter(($container->services['doctrine'] ?? self::getDoctrineService($container)), $a, ($container->privates['property_accessor'] ?? self::getPropertyAccessorService($container)), ($container->privates['logger'] ?? self::getLoggerService($container)), ['titre' => 'partial', 'destination' => 'partial', 'description' => 'partial'], NULL, ($container->privates['serializer.name_converter.metadata_aware'] ?? self::getSerializer_NameConverter_MetadataAwareService($container)));

        if (isset($container->privates['annotated_app_entity_circuit_api_platform_doctrine_orm_filter_search_filter'])) {
            return $container->privates['annotated_app_entity_circuit_api_platform_doctrine_orm_filter_search_filter'];
        }

        return $container->privates['annotated_app_entity_circuit_api_platform_doctrine_orm_filter_search_filter'] = $instance;
    }
}
