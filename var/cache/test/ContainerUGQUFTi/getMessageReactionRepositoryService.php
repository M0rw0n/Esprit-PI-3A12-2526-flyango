 ...
 */
class getMessageReactionRepositoryService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MessageReactionRepository.php';

        return $container->privates['App\\Repository\\MessageReactionRepository'] = new \App\Repository\MessageReactionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
