 ...
 */
class getPromoCodeRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\PromoCodeRepository' shared autowired service.
     *
     * @return \App\Repository\PromoCodeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PromoCodeRepository.php';

        return $container->privates['App\\Repository\\PromoCodeRepository'] = new \App\Repository\PromoCodeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
