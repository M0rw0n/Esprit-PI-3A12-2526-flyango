 ...
 */
class getForumPostRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\ForumPostRepository' shared autowired service.
     *
     * @return \App\Repository\ForumPostRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ForumPostRepository.php';

        return $container->privates['App\\Repository\\ForumPostRepository'] = new \App\Repository\ForumPostRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
