 ...
 */
class get_ServiceLocator_RNyJSA0Service extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.rNyJSA0'])) {
            return $container->privates['.service_locator.rNyJSA0'];
        }

        return $container->privates['.service_locator.rNyJSA0'] = $instance;
    }
}
