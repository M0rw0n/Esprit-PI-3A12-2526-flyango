 ...
 */
class getFavoriteTransportRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\FavoriteTransportRepository' shared autowired service.
     *
     * @return \App\Repository\FavoriteTransportRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FavoriteTransportRepository.php';

        return $container->privates['App\\Repository\\FavoriteTransportRepository'] = new \App\Repository\FavoriteTransportRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
