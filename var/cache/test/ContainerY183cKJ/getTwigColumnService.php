 ...
 */
class getTwigColumnService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['Omines\\DataTablesBundle\\Column\\TwigColumn'] = function ($container) {
            return new \Omines\DataTablesBundle\Column\TwigColumn(($container->privates['twig'] ?? self::getTwigService($container)));
        };
