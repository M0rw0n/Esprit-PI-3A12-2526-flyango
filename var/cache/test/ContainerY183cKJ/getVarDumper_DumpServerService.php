...
class getVarDumper_DumpServerService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['var_dumper.dump_server'] = new \Symfony\Component\VarDumper\Server\DumpServer('', ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
}
