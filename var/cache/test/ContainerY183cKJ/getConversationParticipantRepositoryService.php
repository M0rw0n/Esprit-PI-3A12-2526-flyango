 ...
 */
class getConversationParticipantRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\ConversationParticipantRepository' shared autowired service.
     *
     * @return \App\Repository\ConversationParticipantRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ConversationParticipantRepository.php';

        return $container->privates['App\\Repository\\ConversationParticipantRepository'] = new \App\Repository\ConversationParticipantRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
