...
class getApiPlatform_Doctrine_Orm_QueryExtension_EagerLoadingService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \ApiPlatform\Doctrine\Orm\Extension\EagerLoadingExtension($a, $b, 100, true, false, ($container->privates['api_platform.serializer.mapping.class_metadata_factory'] ?? self::getApiPlatform_Serializer_Mapping_ClassMetadataFactoryService($container)));
