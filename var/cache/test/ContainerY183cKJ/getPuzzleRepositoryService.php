 ...
 */
class getPuzzleRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\Passport\PuzzleRepository' shared autowired service.
     *
     * @return \App\Repository\Passport\PuzzleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Passport'.\DIRECTORY_SEPARATOR.'PuzzleRepository.php';

        return $container->privates['App\\Repository\\Passport\\PuzzleRepository'] = new \App\Repository\Passport\PuzzleRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
