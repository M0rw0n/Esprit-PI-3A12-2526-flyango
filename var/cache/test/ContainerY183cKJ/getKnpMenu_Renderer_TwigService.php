...
class getKnpMenu_Renderer_TwigService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Knp\Menu\Renderer\TwigRenderer($a, '@KnpMenu/menu.html.twig', ($container->services['knp_menu.matcher'] ?? $container->load('getKnpMenu_MatcherService')), []);

        if (isset($container->privates['knp_menu.renderer.twig'])) {
            return $container->privates['knp_menu.renderer.twig'];
        }

        return $container->privates['knp_menu.renderer.twig'] = $instance;
    }
}
