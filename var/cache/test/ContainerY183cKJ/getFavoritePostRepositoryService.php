 ...
 */
class getFavoritePostRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\FavoritePostRepository' shared autowired service.
     *
     * @return \App\Repository\FavoritePostRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FavoritePostRepository.php';

        return $container->privates['App\\Repository\\FavoritePostRepository'] = new \App\Repository\FavoritePostRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
