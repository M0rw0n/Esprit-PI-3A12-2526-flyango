...
class getApiPlatform_JsonSchema_TypeFactoryService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \ApiPlatform\JsonSchema\TypeFactory(($container->privates['api_platform.resource_class_resolver'] ?? self::getApiPlatform_ResourceClassResolverService($container)));

        if (isset($container->privates['api_platform.json_schema.type_factory'])) {
            return $container->privates['api_platform.json_schema.type_factory'];
        }

        $container->privates['api_platform.json_schema.type_factory'] = $instance;
