 ...
 */
class getUserProgressRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\Passport\UserProgressRepository' shared autowired service.
     *
     * @return \App\Repository\Passport\UserProgressRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Passport'.\DIRECTORY_SEPARATOR.'UserProgressRepository.php';

        return $container->privates['App\\Repository\\Passport\\UserProgressRepository'] = new \App\Repository\Passport\UserProgressRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
