...
class get_ServiceLocator_O2p6Lk7Service extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.O2p6Lk7'])) {
            return $container->privates['.service_locator.O2p6Lk7'];
        }

        return $container->privates['.service_locator.O2p6Lk7'] = $instance;
    }
}
