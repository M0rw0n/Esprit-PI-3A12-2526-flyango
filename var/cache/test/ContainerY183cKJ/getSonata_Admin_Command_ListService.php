 ...
 */
class getSonata_Admin_Command_ListService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['sonata.admin.command.list'] = $instance = new \Sonata\AdminBundle\Command\ListAdminCommand(($container->privates['sonata.admin.pool'] ?? self::getSonata_Admin_PoolService($container)));
