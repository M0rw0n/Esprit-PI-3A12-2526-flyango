 ...
 */
class getProfilVoyageurRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProfilVoyageurRepository' shared autowired service.
     *
     * @return \App\Repository\ProfilVoyageurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProfilVoyageurRepository.php';

        return $container->privates['App\\Repository\\ProfilVoyageurRepository'] = new \App\Repository\ProfilVoyageurRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
