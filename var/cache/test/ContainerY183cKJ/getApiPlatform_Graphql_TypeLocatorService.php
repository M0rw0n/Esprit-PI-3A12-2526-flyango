...
class getApiPlatform_Graphql_TypeLocatorService extends App_KernelTestDebugContainer
{
    ...
    {
        return $container->privates['api_platform.graphql.type_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
