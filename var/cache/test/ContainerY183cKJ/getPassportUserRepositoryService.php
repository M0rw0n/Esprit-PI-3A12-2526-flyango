 ...
 */
class getPassportUserRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\Passport\PassportUserRepository' shared autowired service.
     *
     * @return \App\Repository\Passport\PassportUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Passport'.\DIRECTORY_SEPARATOR.'PassportUserRepository.php';

        return $container->privates['App\\Repository\\Passport\\PassportUserRepository'] = new \App\Repository\Passport\PassportUserRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
