...
class getDebug_DumpListenerService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['var_dumper.contextualized_cli_dumper'] ?? $container->load('getVarDumper_ContextualizedCliDumperService'));

        if (isset($container->privates['debug.dump_listener'])) {
            return $container->privates['debug.dump_listener'];
        }

        $instance = new \Symfony\Component\HttpKernel\EventListener\DumpListener(($container->services['var_dumper.cloner'] ?? self::getVarDumper_ClonerService($container)), $a, NULL);

        if (isset($container->privates['debug.dump_listener'])) {
            return $container->privates['debug.dump_listener'];
        }

        return $container->privates['debug.dump_listener'] = $instance;
    }
}
