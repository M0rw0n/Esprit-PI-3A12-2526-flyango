 ...
 */
class getTransportAvisRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\TransportAvisRepository' shared autowired service.
     *
     * @return \App\Repository\TransportAvisRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TransportAvisRepository.php';

        return $container->privates['App\\Repository\\TransportAvisRepository'] = new \App\Repository\TransportAvisRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
