...
class getKnpMenu_FactoryService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Knp\Menu\MenuFactory();

        if (isset($container->services['knp_menu.factory'])) {
            return $container->services['knp_menu.factory'];
        }

        $container->services['knp_menu.factory'] = $instance;
