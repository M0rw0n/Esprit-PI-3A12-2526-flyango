 ...
 */
class getTwigStringColumnService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['Omines\\DataTablesBundle\\Column\\TwigStringColumn'] = function ($container) {
            return new \Omines\DataTablesBundle\Column\TwigStringColumn(($container->privates['twig'] ?? self::getTwigService($container)));
        };
