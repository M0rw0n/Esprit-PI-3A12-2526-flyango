 ...
 */
class getReservationCircuitRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReservationCircuitRepository' shared autowired service.
     *
     * @return \App\Repository\ReservationCircuitRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReservationCircuitRepository.php';

        return $container->privates['App\\Repository\\ReservationCircuitRepository'] = new \App\Repository\ReservationCircuitRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
