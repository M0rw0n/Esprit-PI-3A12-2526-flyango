...
class getCacheWarmerService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () use ($container) {
            ...
            yield 10 => ($container->privates['sonata.admin.route.cache_warmup'] ?? $container->load('getSonata_Admin_Route_CacheWarmupService'));
            yield 11 => ($container->privates['Vich\\UploaderBundle\\Metadata\\CacheWarmer'] ?? $container->load('getCacheWarmer2Service'));
            yield 12 => ($container->privates['exercise_html_purifier.cache_warmer.serializer'] ?? $container->load('getExerciseHtmlPurifier_CacheWarmer_SerializerService'));
        }, 13), true, ($container->targetDir.''.'/App_KernelTestDebugContainerDeprecations.log'));
    }
}
