...
class getLiipImagine_Factory_Config_Filter_ScaleService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['liip_imagine.factory.config.filter.scale'] = new \Liip\ImagineBundle\Factory\Config\Filter\ScaleFactory(($container->privates['liip_imagine.factory.config.filter.argument.size'] ??= new \Liip\ImagineBundle\Factory\Config\Filter\Argument\SizeFactory()));
    }
}
