 ...
 */
class getSonata_Admin_Audit_ManagerService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['sonata.admin.audit.manager'] = new \Sonata\AdminBundle\Model\AuditManager(($container->privates['api_platform.graphql.mutation_resolver_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [], [])));
    }
}
