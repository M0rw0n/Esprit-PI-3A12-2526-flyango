...
class getPagerfanta_EventListener_ConvertNotValidCurrentPageToNotFoundService extends App_KernelTestDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'babdev'.\DIRECTORY_SEPARATOR.'pagerfanta-bundle'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'EventListener'.\DIRECTORY_SEPARATOR.'ConvertNotValidMaxPerPageToNotFoundListener.php';
