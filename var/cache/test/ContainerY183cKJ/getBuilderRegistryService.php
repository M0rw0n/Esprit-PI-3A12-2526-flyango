 ...
 */
class getBuilderRegistryService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->set('default', new \Endroid\QrCode\Builder\Builder(($container->privates['Endroid\\QrCode\\Writer\\PngWriter'] ??= new \Endroid\QrCode\Writer\PngWriter()), [], false, '', new \Endroid\QrCode\Encoding\Encoding('UTF-8'), \Endroid\QrCode\ErrorCorrectionLevel::Low, 300, 10, \Endroid\QrCode\RoundBlockSizeMode::Margin));
