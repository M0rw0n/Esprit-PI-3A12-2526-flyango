 ...
 */
class getOneupFlysystem_CircuitAdapterAdapterService extends App_KernelDevDebugContainer
{
    /**
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['oneup_flysystem.circuit_adapter_adapter'] = $container->createProxy('LocalFilesystemAdapterGhostA489400', static fn () => \LocalFilesystemAdapterGhostA489400::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
