...
class getTranslation_ExtractorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addExtractor('sonata_admin', new \Sonata\AdminBundle\Translator\Extractor\AdminExtractor(($container->privates['sonata.admin.pool'] ?? self::getSonata_Admin_PoolService($container)), ($container->privates['sonata.admin.breadcrumbs_builder'] ?? self::getSonata_Admin_BreadcrumbsBuilderService($container))));
