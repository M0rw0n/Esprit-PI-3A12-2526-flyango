 ...
 */
class getApiPlatform_Graphql_Resolver_Stage_SerializeService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['api_platform.graphql.resolver.stage.serialize'] = new \ApiPlatform\GraphQl\Resolver\Stage\SerializeStage(($container->privates['debug.serializer'] ?? self::getDebug_SerializerService($container)), ($container->privates['api_platform.graphql.serializer.context_builder'] ?? $container->load('getApiPlatform_Graphql_Serializer_ContextBuilderService')), ($container->privates['api_platform.pagination'] ?? $container->load('getApiPlatform_PaginationService')));
    }
}
