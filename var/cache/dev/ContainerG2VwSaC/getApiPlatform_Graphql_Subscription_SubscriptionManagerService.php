 ...
 */
class getApiPlatform_Graphql_Subscription_SubscriptionManagerService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \ApiPlatform\GraphQl\Subscription\SubscriptionManager(($container->privates['api_platform.graphql.cache.subscription'] ?? self::getApiPlatform_Graphql_Cache_SubscriptionService($container)), new \ApiPlatform\GraphQl\Subscription\SubscriptionIdentifierGenerator(), ($container->privates['api_platform.graphql.resolver.stage.serialize'] ?? $container->load('getApiPlatform_Graphql_Resolver_Stage_SerializeService')), $a, $b);
