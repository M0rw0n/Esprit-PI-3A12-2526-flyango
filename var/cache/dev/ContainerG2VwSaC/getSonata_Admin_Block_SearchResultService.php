...
class getSonata_Admin_Block_SearchResultService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'sonata-project'.\DIRECTORY_SEPARATOR.'admin-bundle'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Search'.\DIRECTORY_SEPARATOR.'SearchHandlerInterface.php';
        ...
        $b = new \Sonata\AdminBundle\Search\SearchHandler();
        $b->configureAdminSearch([]);

        $instance = new \Sonata\AdminBundle\Block\AdminSearchBlockService($a, ($container->privates['sonata.admin.pool'] ?? self::getSonata_Admin_PoolService($container)), $b, ($container->privates['sonata.admin.global_template_registry'] ?? self::getSonata_Admin_GlobalTemplateRegistryService($container)), 'show', 'show');

        if (isset($container->services['sonata.admin.block.search_result'])) {
            return $container->services['sonata.admin.block.search_result'];
        }

        return $container->services['sonata.admin.block.search_result'] = $instance;
    }
}
