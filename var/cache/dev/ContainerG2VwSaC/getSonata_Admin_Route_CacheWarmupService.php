...
class getSonata_Admin_Route_CacheWarmupService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['sonata.admin.route.cache_warmup'] = new \Sonata\AdminBundle\Route\RoutesCacheWarmUp(new \Sonata\AdminBundle\Route\RoutesCache(($container->targetDir.''.'/sonata/admin'), true), ($container->privates['sonata.admin.pool'] ?? self::getSonata_Admin_PoolService($container)));
    }
}
