...
class getRouting_LoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $d = ($container->services['kernel'] ?? $container->get('kernel'));
        ...
        $c->addLoader(new \EasyCorp\Bundle\EasyAdminBundle\Router\AdminRouteLoader($a));
        $c->addLoader(new \Sonata\AdminBundle\Route\AdminPoolLoader(($container->privates['sonata.admin.pool'] ?? self::getSonata_Admin_PoolService($container))));
        $c->addLoader(new \ApiPlatform\Symfony\Routing\ApiLoader($d, ($container->privates['api_platform.metadata.resource.name_collection_factory.cached'] ?? self::getApiPlatform_Metadata_Resource_NameCollectionFactory_CachedService($container)), $b, $container, $container->parameters['api_platform.formats'], $container->parameters['api_platform.resource_class_directories'], true, true, true, false, false, NULL));
        $c->addLoader($f);
